...
/// Mercury header for RPC calls
public struct MercuryHeader: Sendable {
    public let uri: String
    public let method: String
    public let contentType: String?

    public nonisolated init(uri: String, method: String = "GET", contentType: String? = nil) {
        self.uri = uri
        self.method = method
...
/// Mercury request structure
public struct MercuryRequest: Sendable {
    public let sequenceId: UInt64
    public let header: MercuryHeader
    public let payload: [Data]

    public nonisolated init(sequenceId: UInt64, header: MercuryHeader, payload: [Data] = []) {
...
/// Mercury response structure
public struct MercuryResponse: Sendable {
    public let sequenceId: UInt64
    public let statusCode: Int
    public let uri: String
    public let payload: [Data]

    public nonisolated init(sequenceId: UInt64, statusCode: Int, uri: String, payload: [Data]) {
        self.sequenceId = sequenceId
